...
/**
 * The chunky bubbly face, used ONLY for the hero headline. Rounded terminals,
 * very heavy at 800 — this is what gives the hero its poster feel. Keeping it
 * to one element means it costs almost nothing.
 */
